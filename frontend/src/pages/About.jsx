  ...
  return (
    <div className="container mx-auto my-12 p-4 space-y-9">
      ...
      <p>
        ...
        dynamic, responsive, and user-friendly web applications, I excels in
      ...
      <p>
        ...
        and NoSQL databases like MySQL, and MongoDB. DevOps:
        ...
        AWS and Google Cloud, enabling scalable and reliable application
        deployment.
      </p>
      <h2 className="font-semibold text-blue-800 text-xl">
      ...
      <br />
      <span>
        I am dedicated to leveraging his expertise to contribute to
        innovative projects and drive technological advancements. Whether
        working on front-end interfaces or back-end logic, passionate
      ...
      <p>
        Beyond his professional achievements, I am is a big fan of cricket
      </p>
    </div>
  );
}
